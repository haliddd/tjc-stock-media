...
export const damShellNavItems: DamShellNavItem[] = [
  ...
  { label: "Distribution Sets", href: "/distribution-sets", icon: PackageCheck, group: "Media", description: "Build governed packages from approved references." },
  { label: "Recent Uploads", href: "/library?view=recent-uploads", icon: FolderClock, group: "Media", description: "Recently submitted or imported media records." },
  { label: "Upload / Intake", href: "/upload", icon: UploadCloud, roles: ["Contributor", "Reviewer", "DAM Admin"], group: "Workflow", description: "Submit files, metadata, rights evidence, people details, and usage scope." },
  { label: "Review Queue", href: "/review", icon: ShieldAlert, roles: ["Reviewer", "DAM Admin"], group: "Workflow", badge: "7", description: "Evaluate evidence, derivatives, access, restrictions, and approvals." },
  ...
  { label: "My Tasks", href: "/requests?view=my-tasks", icon: Bell, group: "Workflow", badge: "4", description: "Role-scoped tasks needing your action." },
  { label: "Rights & Consent", href: "/governance/rights-consent", icon: ShieldCheck, roles: ["Reviewer", "DAM Admin"], group: "Governance", badge: "3", description: "Evidence, consent, owner/license, minors, and public-use approvals." },
  { label: "Metadata Health", href: "/governance/metadata-health", icon: ListChecks, roles: ["Reviewer", "DAM Admin"], group: "Governance", badge: "7", description: "Required fields, duplicate candidates, taxonomy drift, and orphaned records." },
  { label: "Policy Center", href: "/governance/policy-center", icon: ScrollText, roles: ["Reviewer", "DAM Admin"], group: "Governance", description: "Download gates, source restrictions, roles, approval, consent, and expiration rules." },
  { label: "Audit Log", href: "/governance/audit-log", icon: FileCheck2, roles: ["DAM Admin"], group: "Governance", description: "Immutable upload, edit, approval, download, export, and policy events." },
  ...
  { label: "Help Center", href: "/help", icon: HelpCircle, group: "Support", description: "Help articles, quick tasks, requests, and policy shortcuts." }
];
...
export const damShellQuickActions: DamShellNavItem[] = [
  ...
  { label: "New distribution set", href: "/distribution-sets", icon: Boxes, group: "Workflow", description: "Build set" },
  { label: "Review queue", href: "/review", icon: ShieldAlert, roles: ["Reviewer", "DAM Admin"], group: "Workflow", description: "Pending review" }
];
