...
const scaffoldTextPattern = /\b(MVP 2024|stock media candidate|prototype|demo role|hosted beta fixture|hosted pagination fixture|hosted beta pagination|API smoke|qa\.fixture|qa\.blocker|fixture fallback|beta library samples?|read-only sample record)\b/i;
