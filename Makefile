...
cloud-beta-env-check:
	node scripts/cloud-beta-env-check.mjs

cloud-beta-smoke:
	./scripts/cloud-beta-smoke.sh

cloud-beta-resourcespace-bootstrap:
	./scripts/cloud-resourcespace-bootstrap.sh
