...
cloud-beta-preview-preflight:
	node scripts/cloud-beta-preview-preflight.mjs

cloud-beta-preview-preflight-test:
	node scripts/cloud-beta-preview-preflight-test.mjs
