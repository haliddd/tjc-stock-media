...

{
  ...
  echo "- This audit does not import, delete, rename, move, or mutate source media."
  echo "- Run \`make smoke\` and get operator approval before any separate import command."
...
echo "Next: review summary and get operator approval before any separate import command."
