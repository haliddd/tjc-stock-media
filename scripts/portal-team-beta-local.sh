...
export SSO_TRUSTED_HEADERS="${SSO_TRUSTED_HEADERS:-0}"
export PORTAL_ALLOW_BETA_ROLE_OVERRIDE="${PORTAL_ALLOW_BETA_ROLE_OVERRIDE:-0}"
export NEXT_PUBLIC_LOCAL_BETA_ROLE_SWITCH="${NEXT_PUBLIC_LOCAL_BETA_ROLE_SWITCH:-0}"
export DOWNLOAD_GATE_ALLOW_DEMO_ROLES="${DOWNLOAD_GATE_ALLOW_DEMO_ROLES:-0}"
export NEXT_PUBLIC_BETA_TASK_MODE_ENABLED="${NEXT_PUBLIC_BETA_TASK_MODE_ENABLED:-1}"
export NEXT_PUBLIC_BETA_FEEDBACK_ENABLED="${NEXT_PUBLIC_BETA_FEEDBACK_ENABLED:-1}"
